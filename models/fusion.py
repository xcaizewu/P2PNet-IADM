...
class FusionModel(nn.Module):
    ...
    def forward(self, RGBT):
        ...
        RGB, T, shared0 = self.block1(RGB, T, None)
        RGB, T, shared1 = self.block2(RGB, T, shared0)
        RGB, T, shared2 = self.block3(RGB, T, shared1)
        RGB, T, shared3 = self.block4(RGB, T, shared2)
        _, _, shared4 = self.block5(RGB, T, shared3)

        out = [shared0, shared1, shared2, shared3]
